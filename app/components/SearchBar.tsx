...
export default function SearchBar({ navigation, addProduct }: { navigation: any, addProduct: (product: Product) => void }) {
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', borderRadius: 10, padding: 5, margin: 10, backgroundColor: '#fff' }}>
      ...
      <Button title="Lägg till en produkt" color='orange' onPress={() => {
        navigation.navigate("Lägg till produkt", [addProduct]);
      }} />
    </View>
  );
}